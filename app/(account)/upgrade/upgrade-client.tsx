        ...
        return (
          <div className="flex flex-col items-center gap-4 py-12 text-center">
            ...
            <div className="flex flex-col gap-2 w-full max-w-xs">
              ...
              {defaultWorkspaceSlug && (
                <Link
                  href={`/${defaultWorkspaceSlug}/settings?tab=billing`}
    ...
    return (
      ...
      >
        ...
        <div className="flex w-full flex-col gap-2.5">
          <Link
            href={defaultWorkspaceSlug ? `/${defaultWorkspaceSlug}/overview` : '/app'}
            className="flex h-10 w-full items-center justify-center rounded-lg bg-brand px-4 text-[13px] font-semibold text-white transition-colors hover:bg-brand/90"
          >
    ...
    <div className="flex flex-col gap-6">
      ...
      {defaultWorkspaceSlug && (
        <p className="text-center text-[12px] text-foreground-muted">
          Already subscribed?{' '}
          <Link href={`/${defaultWorkspaceSlug}/settings?tab=billing`} className="underline hover:no-underline">
            Manage billing →
          </Link>
        </p>
      )}
