    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="rounded-xl border border-border bg-background-surface p-4 shadow-sm">
          ...
          <p className="mt-1 font-display text-[24px] font-extrabold tracking-tight tabular-nums text-foreground">{workspaces.length}</p>
        ...
        <div className="rounded-xl border border-border bg-background-surface p-4 shadow-sm">
          ...
          <p className="mt-1 font-display text-[24px] font-extrabold tracking-tight tabular-nums text-foreground">{proCount}</p>
