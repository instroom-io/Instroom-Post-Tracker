    ...
    <div className="flex flex-col gap-6 sm:flex-row sm:gap-10">
      ...
      <div className="flex-1 flex flex-col gap-6 max-w-lg">
        ...
        {activeSection === 'storage' && (
          <>
            <div>
              <h1 className="text-[18px] font-semibold text-foreground">Storage</h1>
              <p className="text-[12px] text-foreground-lighter mt-0.5">Google Shared Drive for automatic post downloads.</p>
            </div>
