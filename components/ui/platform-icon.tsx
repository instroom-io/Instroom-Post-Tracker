// Platform SVG icons using the project's design-system platform colors.
// Colors are kept in sync with PLATFORM_COLORS in lib/constants/platform-colors.ts
// and the --platform-* CSS variables in styles/globals.css.
...
// SVG paths sourced from Simple Icons (simpleicons.org) — viewBox 0 0 24 24
...
/** Renders the platform's SVG logo at the given size using the project's platform color. */
